...
Year is a character variable because the columns it came from the columns of the original data frame and R cannot know that these characters represent years. Variable type should be numeric.
...
Line colors, axis labels (title, subtitle, x, y, caption), theme, legend position, and border.
...
statsci |>
  ...
  labs (
    ...
    theme(
      ...
      legend.background = element_rect(fil = "white", color = "gray")
    )
```
